...
def get_model(model_name: str, image_size=None) -> nn.Module:
    registry = {
        ...
        'fpn128_mobilenetv2': partial(fpn_v2, encoder=partial(E.MobilenetV2Encoder, layers=[2, 3, 5, 6, 7]), fpn_features=128),
        'fpn128_mobilenetv3': partial(fpn_v2, encoder=partial(E.MobilenetV3Encoder, layers=[0, 1, 2, 3, 4, 5]), fpn_features=128),
