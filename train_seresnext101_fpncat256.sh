...
python fit_predict.py -m seresnext101_fpncat256 --fp16 -b 32 -w 16 -dd /home/bloodaxe/data/AerialImageDataset --tta d4 --size 512 -s cos -o RAdam -a light  -lr 1e-4 -e 30 -d 0.05 -x seresnext101_fpncat256_light  --run-mode fit -c runs/seresnext101_fpncat256_hard/checkpoints/best.pth
