...
class U2NET(nn.Module):
    def __init__(self, input_channels=3, num_classes=1, pretrained=False):
    ...
    def forward(self, x):
        ...
        return {
            OUTPUT_MASK_KEY: d0,
            OUTPUT_DSV_MASK_1_KEY: d1,
            OUTPUT_DSV_MASK_2_KEY: d2,
            OUTPUT_DSV_MASK_3_KEY: d3,
            OUTPUT_DSV_MASK_4_KEY: d4,
            OUTPUT_DSV_MASK_5_KEY: d5,
            OUTPUT_DSV_MASK_6_KEY: d6,
        }
...
class U2NETP(nn.Module):
    def __init__(self, input_channels=3, num_classes=1, pretrained=False):
        ...
        self.stage1 = RSU7(input_channels, 16, 64)
        self.pool12 = nn.MaxPool2d(2, stride=2, ceil_mode=True)
        ...
        # if pretrained:
        #     state_dict = torch.load(os.path.join(os.path.dirname(__file__), "u2netp.pth"))
        #     self.load_state_dict(state_dict)
